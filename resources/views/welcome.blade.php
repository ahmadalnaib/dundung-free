...
<head>
    ...
    <title>Dundung - A Job platform for Refugee, Built by Refugees</title>
        ...
        <div class="top-0 left-0 items-start hidden w-full h-full p-4 text-sm bg-gray-900 bg-opacity-50 md:items-center md:w-3/4 md:absolute lg:text-base md:bg-transparent md:p-0 md:relative md:flex" :class="{'flex fixed': showMenu, 'hidden': !showMenu }">
            <div class="flex-col w-full h-auto overflow-hidden bg-white rounded-lg md:bg-transparent md:overflow-visible md:rounded-none md:relative md:flex md:flex-row">
                ...
                <div class="flex flex-col items-start justify-center w-full space-x-6 text-center lg:space-x-8 md:w-2/3 md:mt-0 md:flex-row md:items-center">
                    ...
                    <a href="" class="inline-block w-full py-2 mx-0 font-medium text-left text-gray-700 md:w-auto md:px-0 md:mx-2 hover:text-indigo-600 lg:mx-3 md:text-center">Categories</a>
...
<div class=" bg-black text-center m-6 p-6">
    <h2 class="text-center font-bold text-xl text-white">Latest Jobs</h2>
<div class="mt-8">
...
<div class="lg:flex lg:items-center lg:justify-between bg-gray-100 m-6 p-6">

    <div class="flex-shrink-0 p-3 m-3">
        <img class="h-12 w-12 object-cover rounded-full" src="https://stackjobsdev.s3.amazonaws.com/profile-photos/tiidvd3aJD4VWxhRYGlNycWVj4E70p9CkSQuIo2k.png" alt="Toffee, Inc.">
    </div>
